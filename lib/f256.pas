...
//  IO Bank 00
    ...
    MOUSE_PACKET            byte absolute $D6E6;
    ...
    MULU_RESULT             byte absolute $DE10;

    DIVU_DENOM              word absolute $DE04;
    DIVU_NUMR               word absolute $DE06;
    DIVU_RESULT             byte absolute $DE14;
    DIVU_RESULT_Q           word absolute $DE14;
    DIVU_RESULT_R           word absolute $DE16;

    ADD_A                   byte absolute $DE08;
    ADD_B                   byte absolute $DE0C;
    ADD_RESULT              byte absolute $DE18;
